  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-white font-sans ">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-center px-16 bg-white sm:items-start">
          <h3 className="text-4xl font-bold text-center text-black">Blog</h3>
          <p className="text-base font-bold text-center text-black">Welcome to Blog Claude AI. The blog for web developer</p>
